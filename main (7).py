...
Optional environment variables:
    ...
    GEMINI_MAX_TOKENS - defaults to 60 (keeps replies short, 1-3 lines)
...
# Kept small on purpose - this bot is supposed to text like a person, not
# write essays. ~60 tokens is roughly 1-3 short Hinglish lines.
...
def build_prompt(user, mode, history, text):
    ...
    parts = [
        ...
        "REPLY CHHOTA RAKH: zyadatar 1 line me jawab de, kabhi 2 line, "
        "bahut rare 3 line - usse zyada kabhi nahi. Sirf utna hi bata jitna "
        "puchha gaya hai, extra explanation, list, ya lecture mat de. Koi "
        "lamba paragraph nahi likhna, chahe topic serious ho.",
        "Same opening ya same phrase baar baar repeat mat karo, har reply "
        "thoda alag feel ho.",
        "User ki baat dhyan se samjho. Agar emotional ho to halki empathy "
        "dikhao (lekin chhota reply hi rakhna), agar excited ho to "
        "excitement match karo, joke kare to naturally joke wapas karo.",
    ...
    parts.append("Tu (chhota, natural reply - 1-3 line max):")
